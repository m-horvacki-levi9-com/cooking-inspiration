...
describe("RecipeSummariesListItem", () => {
  beforeEach(() => {
  ...
  it("GivenRecipeSummariesListItemData_WhenRenderingComponent_ThenRendersArticleWithTitleHeading", () => {
    // Arrange

    // Act
    render(
      <RecipeSummariesListItem recipe={baseRecipe} onViewDetails={vi.fn()} />,
    );
  ...
  it("GivenRecipeWithLongDescription_WhenRenderingComponent_ThenTruncatesPreviewWithEllipsis", () => {
    ...
    // Act
    render(
      <RecipeSummariesListItem recipe={longRecipe} onViewDetails={vi.fn()} />,
    );
  ...
  it("GivenRecipeWithoutDescription_WhenRenderingComponent_ThenShowsDescriptionFallbackText", () => {
    ...
    // Act
    render(
      <RecipeSummariesListItem recipe={noDescRecipe} onViewDetails={vi.fn()} />,
    );
  ...
  it("GivenRecipeSummariesListItemData_WhenRenderingComponent_ThenRendersViewDetailsButton", () => {
    // Arrange
  ...
  it("GivenRecipeWithoutCookpadUrl_WhenRenderingComponent_ThenDoesNotRenderImportToBringLink", () => {
    ...
    // Act
    render(
      <RecipeSummariesListItem recipe={noUrlRecipe} onViewDetails={vi.fn()} />,
    );
